...
// Given an array of college graduates.  Complete the following requests using any array method you lik
...
const lowAnimalNames = zooAnimals.map(lcan => lcan.animal_name.toLowerCase());
console.log(lowAnimalNames);
...
const lowPop = zooAnimals.filter(lowP => lowP.population < 5 );
console.log(lowPop);
...
let zooAnimalTotal = zooAnimals.reduce((population, zoo) => {
  return population += zoo.population
}, 0);
console.log(zooAnimalTotal);
